...
export default function ProfileTab() {
  ...
  const addNativeLanguage = async () => {
    ...
    if (exists) {
      showToast("This language is already in your native languages", "error");
      return;
    }
    ...
    try {
      ...
      setSelectedNative("");
      showToast("Native language added successfully!", "success");
    } catch (err: any) {
      console.error(err.message || "Failed to add language");
  ...
  const addLearningLanguage = async () => {
    ...
    if (exists) {
      showToast("This language is already in your learning languages", "error");
      return;
    }
    ...
    try {
      ...
      showToast("Learning language added successfully!", "success");
    } catch (err: any) {
      console.error(err.message || "Failed to add language");
      showToast("Failed to add language", "error");
    }
  ...
  const removeLanguage = async (id: string, isLearning: boolean) => {
    try {
      ...
      console.error(err.message || "Failed to remove language");
  ...
  const saveProfile = async () => {
    try {
      ...
      console.error(err.message || "Failed to save profile");
